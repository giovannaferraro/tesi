...
plot "haura-e9-ef-21_left4.txt" using (column(0)):1 with linespoints title "First Column"
...
plot "haura-e9-ef-21_left4.txt" using (column(0)):2 with linespoints title "Second Column"
